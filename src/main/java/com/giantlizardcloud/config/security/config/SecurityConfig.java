...
import com.giantlizardcloud.config.security.handler.*;
import com.giantlizardcloud.config.security.jwt.JWTAuthenticationTokenFilter;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers("/user/code","/user/test"
                        ...
                        ,"/v2/*","/druid/**","/sms/send","/user/verify/**","/excel/**","/inventory/export/**")
                .anonymous()
