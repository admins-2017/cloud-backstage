...
public interface UserMapper extends BaseMapper<User> {
    ...
    @Select("select su.user_id, su.username,su.status,sr.role_id,sr.role_name ,\n" +
            ...
            " left join sys_user_details sud\n" +
            " on  sud.user_id = su.user_id\n" +
            " left join merchant_shop ms on sud.shop_id = ms.shop_id where sud.shop_id = #{id} ")
    IPage<UserDetailsWithRoleAndShopVo> getUserByShop(@Param("id") Long shopId, Page<UserDetailsWithRoleAndShopVo> voPage);
}
